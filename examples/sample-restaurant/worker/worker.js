...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Sample Restaurant - Seasonal Local Dining</title><meta name="description" content="Preview-safe restaurant website example for AFO Site Bundle Manifest v1."><script type="application/ld+json">${JSON.stringify(SCHEMA_JSON)}</script></head><body><main><h1>Sample Restaurant</h1><p>This is a preview-safe restaurant reference website for AFO Site Bundle Manifest v1.</p></main></body></html>`;
...
function text(body, contentType) { return new Response(body, { headers: { 'content-type': `${contentType}; charset=utf-8` } }); }
function json(body) { return new Response(JSON.stringify(body, null, 2), { headers: { 'content-type': 'application/json; charset=utf-8' } }); }
